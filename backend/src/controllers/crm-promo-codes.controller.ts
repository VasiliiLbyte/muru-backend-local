...
const createPromoSchemaBase = z.object({
  code: z.string().min(1),
...
export const listCrmPromoCodesHandler = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const createCrmPromoCodeHandler = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const patchCrmPromoCodeHandler = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const deleteCrmPromoCodeHandler = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const id = parseId(req.params.id)
    if (!id) return fail(res, 400, 'Invalid promo id', 'VALIDATION')
...
export const listCrmPromoCodeUsagesHandler = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
