...
const envSchema = z.object({
  ...
  ORDER_MANAGER_EMAIL: z.union([z.string().email(), z.literal('')]).default('sale@muru.ru'),
  EMAIL_REPLY_TO: z.union([z.string().email(), z.literal('')]).default('info@muru.ru'),
  EMAIL_FROM_NAME: z.string().default('MURU'),
...
export const env = {
  ...
  orderManagerEmail: parsed.data.ORDER_MANAGER_EMAIL || 'sale@muru.ru',
  emailReplyTo: parsed.data.EMAIL_REPLY_TO || 'info@muru.ru',
  emailFromName: parsed.data.EMAIL_FROM_NAME?.trim() || 'MURU',
